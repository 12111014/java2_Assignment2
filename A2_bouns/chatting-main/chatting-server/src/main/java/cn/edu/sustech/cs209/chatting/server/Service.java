...
public class Service implements Runnable{
    ...
    private Thread tForClient;
    private Thread tForMessage;

    /*
    private sendAllOnlineClient sc;
    private transMessage tm;
     */
    ...
    //private BufferedWriter textOutForOnlineClient;
    private ObjectOutputStream objectOutputStreamForOnlineClient;
    //private BufferedWriter textOutForMessage;
    ...
    public Service(Socket socket, Socket socketForClient, Socket socketForMessage,
        ...
        this.objectOutputStreamForOnlineClient = new ObjectOutputStream(outputStreamForOnlineClient);
        ...
        //this.sc = new sendAllOnlineClient(socketForClient, false, onlineClientList);
        //this.tm = new transMessage(socketForMessage,false);
    ...
    public void sendGroupQuitRequestToClient(String roomCode, String quitMemberName) throws IOException {
    ...
    public void checkLogin() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        if(info.equals("yes")){
            ...
            //sending client
            //tForClient = new Thread(sc);
            //tForClient.start();
            //sending message
            //tForMessage = new Thread(tm);
            //tForMessage.start();
            //延迟更新所有用户
            //Thread.sleep(50);
            for (Service s: allService){
    ...
    private void sendGroupMessage() throws IOException, ClassNotFoundException {
        ...
        if(m != null){
            ...
            for(Service s:allService){
                if(sendToName.contains(s.getUserClient().getUserName()) && !s.getUserClient().getUserName().equals(m.getSentBy())){
    ...
    public void sendMessageToClient(Message m) throws IOException {
        objectOutputStreamForMessage.writeObject("message");
        //textOutForMessage.flush();
        //objectOutputStreamForMessage.reset();
        objectOutputStreamForMessage.writeObject(m);
        //objectOutputStreamForMessage.flush();
        System.out.println("服务器成功发送消息");
    }
    ...
    public void sendAllOnlineClient() throws IOException {
        ...
        //objectOutputStreamForOnlineClient.reset();
        objectOutputStreamForOnlineClient.writeObject(copy);
        //objectOutputStreamForOnlineClient.flush();
    }
}
